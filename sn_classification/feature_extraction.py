...
def Wavelet(Gaussian_Data, WaveletType = 'sym2', classification = True, Date = None, length = 15000):
    """
    ...
    for i in Data_uqlst:
        ...
        #b = Gaussian_Data[(Gaussian_Data['event']==i)]['band'].unique() == np.array([0.0, 1.0])
